-- 🔬 Suite de pruebas §54: datos, RPCs públicas y AISLAMIENTO DE TENANTS
-- Ejecutar tras migración + seed (en Supabase no requiere stubs):
--   psql "$DB_URL" -f supabase/tests/tenant-isolation.sql
